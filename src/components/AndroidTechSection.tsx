...
import { Bot, Cpu, ArrowRight } from 'lucide-react';

export const AndroidTechSection: React.FC = () => {
  const { navigate } = useApp();
  const techProducts = PRODUCTS.filter((p) => p.isAndroid || p.category === 'drinkware').slice(0, 4);
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10">
          <div className="space-y-1">
            ...
            <p className="text-sm text-neutral-600 dark:text-neutral-400 max-w-xl">
              Official Android metallic vinyl figures, vacuum insulated travel bottles, developer patches, and desk tech gear.
            </p>
          </div>
